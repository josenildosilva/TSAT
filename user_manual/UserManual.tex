...
Rips complex
shouldConsolidate  If 1 will merge values in the time series that are
less than 10 time steps apart.
...
\noindent\texttt{mvn javadoc:javadoc}\\
in the root directory of {\TSAT}.  This will generate javadoc  in the directory\\
\texttt{target/site/apidocs/}
Then loading index.html in a browser will let you explore the generated javadoc.
